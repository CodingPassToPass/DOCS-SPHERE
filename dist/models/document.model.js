...
import { Column, DataType, Default, ForeignKey, Table, HasMany, BelongsToMany, Model, DefaultScope } from "sequelize-typescript";
...
__decorate([
    ...
    __metadata("design:type", Array)
], Document.prototype, "documentUsers", void 0);
__decorate([
    Default(false),
